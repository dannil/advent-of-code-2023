    ...
    fn minimum_cubes(game: &String) -> u32 {
        ...
        for subset in sets {
            ...
            for cube in subsets {
                ...
                minimum_cubes_needed.insert(color.to_string(), new_minimum.clone());
            }
        }
...
mod tests {
    ...
    fn actual_input() -> String {
        ...
        Game 100: 1 red, 4 blue, 2 green; 6 red, 2 green, 11 blue; 1 red, 1 blue, 2 green; 1 red, 7 blue".to_string()
    }
}
